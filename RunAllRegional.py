...
if arg_number == 1:
    ...
    print('Please enter 1,2,3 or 4 for Regional on X, Y, X and Y or neither')
...
# Save to
plot_dir = '/rds/general/user/lm2612/home/Outputs/DimRed/Outputs_70-100_yrs_GP_Regional_{}_'.format(regional_on)


# Test data set
print(Names)

# our function of interest for Regional is
if __name__ == '__main__':
    ...
    processes = [mp.Process(target=TrainTestRegional, args=(X,y,Names,[name],lons,lats,lons1,lats1,area_flat,plot_dir,RegionOnlyList,regional_X,regional_Y)) for name in Names]
